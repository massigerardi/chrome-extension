var factory = function(
    ...
    /**
     * Spawner for Notification
     */
    var NotificationSpawner = function() {
        this.initialize.apply(this, arguments);
    };

    _.extend(NotificationSpawner.prototype, {
        initialize: function(opts) {
            ...
            this._transportStrategyOptions = _.extend({}, opts.getOrError("transportStrategyOptions"), {
                inboundFilter: function(msg) {
                    ...
                    // the notification-remote-process-delegate (which responds to health checks)
                    // and the RemotePlatform:RemoteProcessDelegate (which is the RemotePlatform
                    // client for PlatformService).
                    return msg.origin === "RemotePlatform:RemoteProcessDelegate:Notification" || msg.origin === "notification-remote-process-delegate"
                }
            });
            this._identity = opts.getOrElse("identity", "notification-remote-process");
        },
        /**
