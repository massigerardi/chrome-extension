...
var factory = function(
    ...
    /**
     * Simple mixin for adding pub/sub to a class. Usage is straightforward:
     *
     ...
     *     var Klass = function() {};
     *
     *     _.extend(Klass.prototype, Event, {
     *         foo: function() {
     *             this.notify('foo', 1, 2, 3);
     *         }
     *     });
     *
     *     var instance = new Klass();
     *     instance.on('foo', handler);
     *     instance.foo(); // causes 1, 2, 3, to be logged
     *
     *
     */
    var Events = {
